...
// Re-export EmailData for use in tests
export type { EmailData };

/**
 * Class for criteria evaluation, mirroring Python's CriteriaGrade
 */
 ...
 */
export async function runInitialStream(emailAssistant: any, emailInput: EmailData, threadConfig: any) {
  const messages = [];
 ...
 */
export async function runStreamWithCommand(emailAssistant: any, command: Command, threadConfig: any) {
  const messages = [];
 ...
 */
export function isModuleCompatible(requiredModules: string[]): boolean {
 ...
 */
export async function processStream(emailAssistant: any, inputData: any, threadConfig: any) {

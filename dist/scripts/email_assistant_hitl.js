...
import { HITL_TOOLS_PROMPT, triageSystemPrompt, triageUserPrompt, agentSystemPromptHitl, defaultBackground, defaultResponsePreferences, defaultCalPreferences, defaultTriageInstructions } from "../lib/prompts.js";
 ...
 */
export const initializeHitlEmailAssistant = async (checkpointer) => {
    // Get tools
    ...
    const interruptHandlerNode = async (state) => {
    ...
    const triageRouterNode = async (state) => {
        try {
            ...
            const jsonSystemPrompt = `${systemPrompt}\n\nProvide your response in the following JSON format:
{
  ...
  "classification": "ignore" | "respond" | "notify"
            ...
            let classification = "notify"; // Default to notify
            try {
    ...
    const triageInterruptHandlerNode = async (state) => {

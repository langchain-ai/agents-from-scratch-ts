...
import { triageSystemPrompt, triageUserPrompt, agentSystemPrompt, defaultBackground, defaultResponsePreferences, defaultCalPreferences, defaultTriageInstructions, AGENT_TOOLS_PROMPT } from "../lib/prompts.js";
import { BaseEmailAgentState } from "../lib/schemas.js";
import { parseEmail, formatEmailMarkdown } from "../lib/utils.js";
            ...
            const jsonSystemPrompt = `${systemPrompt}\n\nProvide your response in the following JSON format:
{
  ...
  "classification": "ignore" | "respond" | "notify"
            ...
            let classification = "ignore"; // Default
            try {

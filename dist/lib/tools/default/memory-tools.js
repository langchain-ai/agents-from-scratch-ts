 ...
 */
export const backgroundTool = tool(async () => {
 ...
 */
export const calPreferencesTool = tool(async () => {
    // This tool is a placeholder as the actual functionality happens in the agent implementation
 ...
 */
export const responsePreferencesTool = tool(async () => {
    // This tool is a placeholder as the actual functionality happens in the agent implementation
 ...
 */
export const questionTool = tool(async ({ content }) => {
